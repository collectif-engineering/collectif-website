      ...
      <div>
        ...
        >
          <svg
            ...
            height="70px"
            viewBox="0 0 24 24"
            className="stroke-pink-600 fill-none group-hover:fill-rose-950 group-active:stroke-rose-950 group-active:fill-slate-700 group-active:duration-0 duration-300"
          >
            <path
